...
import { useUpdateLoanMutation } from "../redux/services/loan"
import { useParams } from 'react-router-dom';

const UpdateLoan = () => {

    const { loan_id, user_id } = useParams();



    const [updateData, { isLoading }] = useUpdateLoanMutation();
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const res = await updateData({ loan_id, user_id, data: { ...formData, owner_id: parseInt(user_id) } });
